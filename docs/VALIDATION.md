...
- 紧凑包 `0.4.1 (1789362907)` 已通过双架构构建、真实 librime 控制器回归和成品包检查，SHA-256 为 `409a3db99c06d4f5f1a45c322e5f6561096b1c8ebca0606fcb6ec9e8fa440ee9`；日志 `/tmp/rimeq-compact-build.log`。已归档现用包，发起正常系统认证安装；当前会话旧“中”的刷新仍未通过，未将这个显示问题记为已修复。
