...
- 独立 TextEdit 文档已验证中文全拼/空格上屏、点击状态项转英文、英文直通，得到合成文本 `你好nihao`。自动模拟 Shift 的后续检查未通过，实体键盘表现待用户核对；未将这一项写成真实宿主通过。前台/文档保护多次拦截失焦时发键，测试仅使用 `/tmp/rimeq-mode-acceptance.txt`。
