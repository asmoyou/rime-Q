...
0.4.0 起各平台统一锁定官方 LTS 资产 `558301149`（2026-09-12 更新），大小 `420343852` 字节，SHA-256 `9f80530f470033cfb6d4b44bb861b540f64100426f92dd0f87140883632a3d93`，仍为 amzxyz 的原始 CC-BY-4.0 模型。共用元数据位于 `wanxiang_model`；下载与引擎使用均校验此摘要，不把上游同名资产视为可以跳过校验的固定内容。已发布版本使用过的历史模型锁保留在相应发布记录中。
